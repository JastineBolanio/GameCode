# Security Policy for coding_game
...
If you discover a security vulnerability in "coding_game," please report it responsibly. Do not disclose it publicly until we've had a chance to address it.

- **How to Report**: Email the team ator open a private issue on GitHub (use the "Report a vulnerability" feature if available).
...
Thank you for helping keep "coding_game" safe for educational use!
